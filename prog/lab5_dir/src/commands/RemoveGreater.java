...
/**
 * Команда для удаления из коллекции всех элементов, у которых значение поля population превышает заданное.
 */
public class RemoveGreater extends Command {
    ...
    /**
     * Выполняет команду удаления элементов, у которых значение поля population превышает заданное.
     *
