...
1. Определенные интегралы — для трех заданных многочленов любой точности и любых границ.
2. Несобственные интегралы 2‑го рода — когда функция имеет разрыв в одной точке (в начале, в конце или внутри отрезка).

Для каждого расчета можно выбрать метод (прямоугольники, трапеции, Симпсон) и задать требуемую точность.
